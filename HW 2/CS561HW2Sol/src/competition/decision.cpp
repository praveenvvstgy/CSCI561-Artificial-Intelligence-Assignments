...
int getdepth(int board_size, float cputime, int vacant_positions) {
	std::ostringstream stringStream;
	stringStream << "python depthPredict.py ";
	stringStream << board_size << " " << int(cputime) << " " << vacant_positions;
	std::string copyOfStr = stringStream.str();
	system(copyOfStr.c_str());
	fstream inoutfile;
	inoutfile.open("depth");
...
int main(int argc, char const *argv[])
{
    ...
    maxdepth = getdepth(n, cputime, vacant_positions.size());
